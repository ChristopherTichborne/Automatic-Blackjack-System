...
def find_cards(thresh_image,image):
    ...
    # Find contours and sort their indices by contour size (Removed 'Dummy' From line 133)
...
def preprocess_card(contour, image):
    ...
    #cv2.imshow("contours",query_thresh)
    #cv2.waitKey(0)     
...
def match_card(qCard, train_ranks, train_suits):
    ...
    if (len(qCard.rank_img) != 0) and (len(qCard.suit_img) != 0):
        #cv2.imshow("rank image",qCard.rank_img)
        #cv2.waitKey(0)
    ...
    if (best_rank_match_name == "Ace"):
        is_ace = True
    else:
        is_ace = False
    # Return the identiy of the card and the quality of the suit and rank match
    return best_rank_match_name, best_suit_match_name, best_rank_match_diff, best_suit_match_diff, is_ace
